            ...
            <div className="container">
                ...
                <div className="group/projects relative" ref={containerRef}>
                    {selectedProject !== null && (
                        <div
                            className="max-md:hidden absolute left-2/3 -ml-[220px] xl:-ml-[300px] top-0 z-[1] pointer-events-none w-[440px] xl:w-[600px] aspect-[4/3] overflow-hidden opacity-0 rounded-2xl shadow-2xl shadow-black/50"
                            ref={imageContainer}
                        >
